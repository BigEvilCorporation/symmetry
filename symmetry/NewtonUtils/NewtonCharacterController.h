#include "Newton/customJoints/NewtonCustomJoint.h"


class NewtonPlayerController: public NewtonCustomJoint
{
   public:
   NewtonPlayerController(const dVector& pin, const NewtonBody* child, dFloat maxStairStepFactor);
   virtual ~NewtonPlayerController();
