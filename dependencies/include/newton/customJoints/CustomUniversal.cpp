...
//	 info->m_minAngularDof[0] = m_minAngle_0 * 180.0f / 3.1416f ;
//	 info->m_maxAngularDof[0] = m_maxAngle_0 * 180.0f / 3.1416f ;
	 ...
	 if (m_limit_0_On) {
		 ...
		 info->m_minAngularDof[0] = (m_minAngle_0 - angle) * 180.0f / 3.1416f ;
		 info->m_maxAngularDof[0] = (m_maxAngle_0 - angle) * 180.0f / 3.1416f ;
	 } else {
		 info->m_minAngularDof[0] = -FLT_MAX ;
		 info->m_maxAngularDof[0] =  FLT_MAX ;
	 }

//	 info->m_minAngularDof[1] = m_minAngle_1 * 180.0f / 3.1416f;
//	 info->m_maxAngularDof[1] = m_maxAngle_1 * 180.0f / 3.1416f;
	 ...
	 if (m_limit_1_On) {
		 ...
		 info->m_minAngularDof[1] = (m_minAngle_1 - angle) * 180.0f / 3.1416f ;
		 info->m_maxAngularDof[1] = (m_maxAngle_1 - angle) * 180.0f / 3.1416f ;
	 } else {
